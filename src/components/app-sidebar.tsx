  ...
  return (
    ...
    >
      <SidebarContent className="bg-sidebar">
                          ...
                          <>
                            ...
                            {item.badge && (
                              <span
                                ...
                                className="ml-auto bg-hazard/20 text-hazard text-[10px] px-1.5 py-0.5 rounded font-semibold"
                              >
                                {item.badge}
                              </span>
                            )}
        ...
        {!collapsed && (
          <aside aria-label="Predictive signal" className="mt-auto p-4">
            <div className="p-4 bg-secondary/40 rounded-xl border border-border">
              <div className="flex items-center gap-2 mb-2">
                <Activity aria-hidden="true" className="size-3.5 text-cyber" />
              ...
              <button
                type="button"
                className="w-full py-2 bg-cyber text-cyber-foreground text-xs font-bold rounded hover:brightness-110 transition-all font-display tracking-wide focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                GENERATE BRIEF
              </button>
            </div>
